...
class CoinStatsIndexTest(BitcoinTestFramework):
    ...
    def _test_coin_stats_index(self):
        ...
        res4 = index_node.gettxoutsetinfo('none', 0, True)
        assert_equal(res4['total_unspendable_amount'], 50)
        assert_equal(res4['block_info'], {
            'unspendable_amount': 50,
        ...
        res5 = index_node.gettxoutsetinfo('none', 102, True)
        ...
        res6 = index_node.gettxoutsetinfo('none', 108, True)
        ...
        res7 = index_node.gettxoutsetinfo('none', 109, True)
