...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-signer=<cmd>", "External signing tool, see doc/external-signer.md. Use -signer=internal for the built-in C++ hardware wallet interface.", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
#endif
