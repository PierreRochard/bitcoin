...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "createwallet", 8, "signer", ParamFormat::STRING },
    { "preparerecoveryvault", 0, "wallet_name", ParamFormat::STRING },
    { "preparerecoveryvault", 1, "recovery_kit_path", ParamFormat::STRING },
    { "createrecoveryvault", 0, "recovery_kit_path", ParamFormat::STRING },
    { "createrecoveryvault", 1, "kit_commitment", ParamFormat::STRING },
    { "createrecoveryvault", 2, "finish_unverified" },
    { "createmultisigdescriptor", 0, "nrequired"},
    { "createmultisigdescriptor", 1, "keys"},
    { "createmultisigdescriptor", 2, "options"},
